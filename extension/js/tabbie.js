...
function main(){
  loadTabs();
  document.querySelector('#saveall').addEventListener('click', helper.saveAll);
  document.querySelector('#savepinned').addEventListener('click', helper.savePinned);
